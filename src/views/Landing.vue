      ...
      <div class="compare-grid">
        <div class="compare-card them">
          ...
          <div class="compare-calc">
            <div class="calc-row">
              <span>Pedidos no mês</span><span>{{ pedidos }}</span>
            </div>
            <div class="calc-row">
          ...
          <p class="calc-note">
            * Valores ilustrativos baseados em modelos de cobrança comuns no
            mercado
          </p>
        </div>
        <div class="compare-card us">
          ...
          <div class="compare-sub">
            Quanto mais você vende, mais você economiza
          </div>
          <div class="compare-calc">
            <div class="calc-row">
              <span>Pedidos no mês</span><span>{{ pedidos }}</span>
            ...
            <div class="calc-row">
              <span>Taxa por pedido</span><span class="teal-text">R$ 0,00</span>
            </div>
            <div class="calc-row">
